...
def simular(ea: str, eb: str, sede: str, arbitro: str = None, n: int = 10_000) -> dict:
    ...
    ARBITROS_MUNDIAL_2026 = {
        ...
        "Jalal Jayed":             (0.8,  2),  # 0am Uzb + 2am Ger-Par (90min, resto ET)
...
DATOS_REALES = {
    ...
    # R32 — 29 junio
    "Brasil_Japon":                  {"am": 5,  "co": 8},   # 2 BRA + 3 JAP | 6 BRA + 2 JAP
    "Alemania_Paraguay":             {"am": 2,  "co": 16},  # 1 ALE + 1 PAR en 90min | 16+6 COR total
}

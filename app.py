...
HORARIOS_PARTIDO = {
    ...
    ("TBD-QF-2A", "TBD-QF-2B"): "2026-07-10 13:00",
    ("TBD-QF-3A", "TBD-QF-3B"): "2026-07-11 15:00",
    ("TBD-QF-4A", "TBD-QF-4B"): "2026-07-11 19:00",
...
FORMA_MUNDIAL = {
    ...
    "Inglaterra": (8, 3, 4), "Croacia": (5, 7, 4), "Ghana": (2, 5, 4), "Panama": (0, 4, 3),
}
...
BAJAS = {
    ...
    'Argentina': 0.97,  # 120min vs Cabo Verde (ET, gol 111')
    'Egipto':    0.97,  # 120min vs Australia (ET + penales)
    # Alemania: eliminada, sin efecto
    # PaísesBajos: eliminada, sin efecto
    # Senegal: eliminada, sin efecto
    # Australia: eliminada, sin efecto
    # Cabo Verde: eliminada, sin efecto
}
...
def simular(ea: str, eb: str, sede: str, arbitro: str = None, n: int = 10_000) -> dict:
    ...
    if arbitro and arbitro in ARBITROS_MUNDIAL_2026:
        ...
        if n_partidos == 0:
            # Sin partidos en este torneo — usar solo histórico ajustado
            lam_am_arb = lam_am_arb_raw * FACTOR_ARB_MUNDIAL
            lam_ro_arb = lam_ro_arb_raw * FACTOR_ARB_MUNDIAL
        else:
            # Con partidos reales — más peso al dato real según cantidad de partidos pitados
